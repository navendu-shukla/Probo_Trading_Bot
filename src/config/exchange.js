import { stocks, oldStockPrices } from "./prices";
...
function fluctuatePrice(symbol) {
  ...
  const newPrice = currentPrice + VARIANCE_FACTOR * variance; // Random change within ±10%
...
export function simulateStockMarket() {
  setInterval(() => {
